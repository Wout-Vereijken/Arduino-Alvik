...
def loop():
  global c1, c2, c3, c4, LastColor, TurnedAround, color_1, color_2, color_3, color_4   # â allow modification of these globals
  left, cleft, center, cright, right = alvik.get_distance()
  get_color = alvik.get_color_raw()

  is_color_1 = check_color(color_1, get_color, 0.19) if color_1 else False
  is_color_2 = check_color(color_2, get_color, 0.10) if color_2 else False
  is_color_3 = check_color(color_3, get_color, 0.10) if color_3 else False
  is_color_4 = check_color(color_4, get_color, 0.10) if color_4 else False
